...
CREATE TABLE `authors` (
  ...
  KEY `ix_authors_author_id` (`author_id`)
...
INSERT INTO `categories` VALUES (3,'Fairy Tales'),(4,'Mathematics'),(2,'Science Fiction');
...
CREATE TABLE `members` (
  ...
  KEY `ix_members_member_id` (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-04-29 16:57:48
